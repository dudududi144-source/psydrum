...
- [ ] **A1.2**: יישום מודל חישובי של מעגל הסינון (state-variable filter)
- [ ] **A1.3**: שילוב המודל ב-kick-engine.ts (החלפת ה-Moog ladder הפשוט)
- [ ] **A1.4**: בדיקות render-proof לאימות הסאב והחום האנלוגי
